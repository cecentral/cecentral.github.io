...
<head>
    ...
    <title>Guidebook | <?php echo e($title); ?></title>
    ...
    <script src="<?php echo e(elixir('js/app.js')); ?>" type="text/javascript"></script>
...
<body>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="cecentral.atlassian.net">Jira</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
    ...
    <div class = "container">
        ...
        <div class="flex-center position-ref">
            ...
            <div class="col-lg"><?php echo $__env->yieldContent('markdown'); ?></div>
